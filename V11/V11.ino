...
#define Lm35pin 2         // Pin del sensor de temperatura LM35DZ
#define dht_22 0         // Pin del sensor de temperatura y humedad DHT22
#define sensormq9 4      // Define el pin analógico donde está conectado el sensor MQ-9
// Rele pines
#define bombapin 36       // Pin del relé 1 (Bomba de agua)
#define luzpin 39          // Pin del relé 2 (Iluminación)
#define ventilacionpin 34  // Pin del relé 3 (Ventilación)
#define ventilacionpin2 35  // Pin del relé 4 ()
